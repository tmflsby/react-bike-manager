    ...
    return (
      <div>
        ...
        <Card title='按钮尺寸' className="card-wrap">
          ...
          <Button type='primary' size={this.state.size}>Imocc</Button>
          <Button size={this.state.size}>Imocc</Button>
          <Button type='dashed' size={this.state.size}>Imocc</Button>
          <Button type='danger' size={this.state.size}>Imocc</Button>
        </Card>
      </div>
    );
  }
